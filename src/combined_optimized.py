...
MAX_WORKERS = 12  # ThreadPoolExecutor: use fewer workers (12-16 for 18 cores)
CHECKPOINT_EVERY = 15  # Smaller batches to prevent memory accumulation (was 25)
RESUME = True
...
def main():
    ...
    if remaining_files:
        # ThreadPoolExecutor allows JPEG/OpenCV/PyTorch work to overlap
        # with checkpoint writes. Works with nested process_one function.
