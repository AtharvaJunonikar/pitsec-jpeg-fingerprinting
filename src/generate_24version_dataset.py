#!/usr/bin/env python3
"""
PITSEC: Generate 24-Version JPEG Dataset
...
VERSION_LIST = [
    '6b', '7', '8', '8a', '8b', '8c', '8d', '9', '9a', '9b', '9c', '9d', 
    '9e', '9f', 'turbo120', 'turbo130', 'turbo140', 'turbo150', 'turbo200', 
    'turbo210', 'mozjpeg101', 'mozjpeg201', 'mozjpeg300', 'mozjpeg403'
]
...
def compress_with_version(input_path, output_path, version, quality=75):
    ...
    Args:
        ...
        version: libjpeg version (e.g., '6b', '7', '9e')
